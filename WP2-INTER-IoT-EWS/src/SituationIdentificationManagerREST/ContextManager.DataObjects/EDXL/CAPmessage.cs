...
namespace ContextManager.DataObjects.EDXL
{
    public class CAPmessage
    {
        ...
        public CAPmessage(string situationType, Dictionary<String, object> attributesFromEPL, SituationInference situationInference)
        {
            msgCAP = new CAP();
            ...
            string messageID = "edxl_cap_inst:AlertMessage_" + situationTypeIdentified + "_" + attributesDataFromSituationIdentified["TriggerSituationEventTimeStamp"] + "_" + Guid.NewGuid().ToString();
        ...
        private JToken ConvertToInstanceInJsonLD(string instanceID, string instanceType)
        {
