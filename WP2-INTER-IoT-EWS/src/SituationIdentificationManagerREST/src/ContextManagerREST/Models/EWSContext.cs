...
namespace INTERIoTEWS.SituationIdentificationManager.SituationIdentificationREST.Models
{
    public class EWSContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<INTERIoTEWS.Context.DataObjects.SAREF.DeviceObservation> DeviceObservations { get; set; }
