...
namespace MyDriving.ViewModel
{
    public class LoginViewModel : ViewModelBase
    {
        ...
        async Task<bool> LoginAsync(MobileServiceAuthenticationProvider provider)
        {
            ...
            {
                temp += "Settings.UserFirstName: " + Settings.UserFirstName + "... ";
                ...
                Acr.UserDialogs.UserDialogs.Instance.Alert("Unable to login or create account. Why? temp=" + temp, "Login error", "OK");
                return false;
            }
            else
            {
