package md5d7fa9cf0db20f3a1f4ac8788cd175af7;


public class AccelerometerManager_ShakeSensorEventListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyDriving.Droid.Helpers.AccelerometerManager+ShakeSensorEventListener, MyDriving.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AccelerometerManager_ShakeSensorEventListener.class, __md_methods);
	}


	public AccelerometerManager_ShakeSensorEventListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AccelerometerManager_ShakeSensorEventListener.class)
			mono.android.TypeManager.Activate ("MyDriving.Droid.Helpers.AccelerometerManager+ShakeSensorEventListener, MyDriving.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
