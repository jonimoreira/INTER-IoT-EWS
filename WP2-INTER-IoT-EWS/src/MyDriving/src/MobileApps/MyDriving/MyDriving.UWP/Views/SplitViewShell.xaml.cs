...
namespace MyDriving.UWP.Views
{
    ...
    public sealed partial class SplitViewShell
    {
        ...
        public SplitViewShell(Frame frame)
        {
            ...
            string prefixLabels = "INTERIoTEWS ";

            Current.LabelText = prefixLabels + "Current Trip";
            ...
            PastTrips.LabelText = prefixLabels + "Past Trips";
            ...
            Profile.LabelText = prefixLabels + "Profile";
            ...
            Settings.LabelText = prefixLabels + "Settings";
